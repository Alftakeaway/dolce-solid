    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-action {
            display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #ffffff; color: white; border: 2px solid var(--primary); padding: 9px 18px; font-size: 0.9rem; font-weight: 600; border-radius: 6px; text-decoration: none; margin-top: 15px; transition: all 0.3s ease; box-shadow: 0 2px 5px rgba(0,0,0,0.05);
        }
        .btn-action:hover { background: var(--dark); color: var(--primary); border-color: var(--dark); transform: translateY(-2px); }
