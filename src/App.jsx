...
function App() {
  ...
  // Rimosse completamente le foto da Spigola e Baccalà. Ora solo Margherita e Carbonara hanno la foto reale.
  const menuItems = [
    // NIBBLES
    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* BOTTONE SPECIALS - ORO + BORDO ARANCIONE */
        .btn-filter.specials { 
